    ...
    public class GameManagerAlquimia : MonoBehaviour
    {
        ...
        public void NextScene()
        {
            ...
            else
            {
                ...
                containerModalFinalResults.GetComponentInChildren<TMP_Text>().text = "Pontuação Total: " + ScoreManager.GetTotalScore().ToString();
                ...
                {
                    playerData = new PlayerData(currentPhase: 4, punctuation: ScoreManager.GetTotalScore());
                }
                else
                {
